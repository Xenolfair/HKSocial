$(function(){
    ...
    function updateStats(){
      $('#stats').html('<div class="padded"><h2>Figuras: <span>'+
        '<b>'+get('flip_won')+'</b><i>Ganadas</i>'+
        '<b>'+get('flip_lost')+'</b><i>Perdidas</i>'+
        '<b>'+get('flip_abandoned')+'</b><i>Abandonadas</i></span></h2>'+
        '<ul><li><b>Mejor Fácil 👶:</b> <span>'+toTime( get('flip_casual') )+'</span></li>'+
        '<li><b>Mejor Medio 🪽:</b> <span>'+toTime( get('flip_medium') )+'</span></li>'+
        '<li><b>Mejor Difícil 😈:</b> <span>'+toTime( get('flip_hard') )+'</span></li></ul>'+
        '<ul><li><b>Total Flips🔎:</b> <span>'+parseInt( ( parseInt(get('flip_matched')) + parseInt(get('flip_wrong')) ) * 2)+'</span></li>'+
        '<li><b>Aciertos 🎯:</b> <span>'+get('flip_matched')+'</span></li>'+
        '<li><b>Errores 📉:</b> <span>'+get('flip_wrong')+'</span></li></ul></div>');
    };
